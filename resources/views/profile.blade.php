          ...
          <div class="box bg-inverse bg-dark bg-hexagons-white">
            <div class="box-body box-profile">
              ...
              <div class="row social-states">
                <div class="col-6 text-right"><a href="#" class="link text-white"><i class="ion ion-money"></i> ${{ $usd_wallet }}</a></div>
				<div class="col-6 text-left"><a href="#" class="link text-white"><i class="ion ion-money"></i> {{ $btc_wallet }} BTC</a></div>
			  </div>
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal form-element col-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="inputName" value="{{ $username }}" disabled>
                    </div>
                  </div>
                  <div class="form-group row">
